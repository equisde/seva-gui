...
SevaBit is a private cryptocurrency based on Monero. Over the course of the coming months, the SevaBit project aims to offer an incenvised full node layer with a secondary p2p network that offers a private communications layer based on the Signal protocol.
...
## Compiling the SevaBit GUI from source

### On Linux:

(Tested on Ubuntu 17.10 x64, Ubuntu 18.04 x64 and Gentoo x64)

1. Install SevaBit dependencies
...
The SevaBit GUI on Windows is 64 bits only; 32-bit Windows GUI builds are not officially supported anymore.

1. Install [MSYS2](https://www.msys2.org/), follow the instructions on that page on how to update system and packages to the latest versions

2. Open an 64-bit MSYS2 shell: Use the *MSYS2 MinGW 64-bit* shortcut, or use the `msys2_shell.cmd` batch file with a `-mingw64` parameter

3. Install MSYS2 packages for SevaBit dependencies; the needed 64-bit packages have `x86_64` in their names
