...
linux {
   ...
   #     }
    ...
    # currently sevabit has an issue with "static" build and linunwind-dev,
...
# translation stuff
TRANSLATIONS = $$files($$PWD/translations/sevabit-core_*.ts)
...
DISTFILES += \
    notes.txt \
    sevabit/src/wallet/CMakeLists.txt \
